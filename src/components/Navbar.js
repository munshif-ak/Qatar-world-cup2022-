...
function Navbar() {
  return (
    ...
    <div className='nav-bar'>
      <img style={{marginLeft:'20px'}} src='https://digitalhub.fifa.com/transform/befe3a64-328b-453c-8b58-0faeb9103684/FIFA_Logo_White_Generic?io=transform:fill&quality=75' width={50} height={15}/>
    ...
    <div className='second-nav'>
      <App/>
      <img src='https://digitalhub.fifa.com/transform/3a170b69-b0b5-4d0c-bca0-85880a60ea1a/World-Cup-logo-landscape-on-dark?io=transform:fill&quality=75' width={104} height={47}/>
      <div className='categories'>
        <a href=''> NEWS</a>
        <a href=''>HIGHLIGHTS </a>
        <a href=''>KNOCKOUT & GROUPS</a>
        <a href=''>SCORES & FIXTURES</a>
        <a href=''>TEAMS</a>
        <a href=''>FIFA WORLD CUP TROPHY TOUR</a>
        <a href=''>FIFA FAN FESTIVAL™</a>
      </div>
