      ...
      {ScoreFixture.map((s) => (
        <div className="score-fixture-ncontainer1">
          <div className="date-contai">
            <span>{s.date}</span>
            <a
              style={{ fontSize: "16px", fontWeight: "500", color: "#00968d" }}
            >
              View groups
            </a>
          </div>
          {s.fixture.map((f) => (
            <>
            <Link to={'/score-fixture/'+f.id}  className="text-deceration">
            <div className="fixtures">
              <div className="fixtures-1">
                <div className="matchno-group">
          ...
          <div className="adidas">
            <img
              src="https://digitalhub.fifa.com/transform/fb7a438c-6c83-442f-a635-fb1e6e613b3a/adidas-schedule-banner-kvg-1160x68?io=transform:fill&quality=75"
              width={936}
              height={54}
            />
          </div>
